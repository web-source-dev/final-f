...
const ViewData = () => {
  ...
  const filteredUsers = users.filter((user) => {
   ...
   if (!isAuthenticated && twoFAEnabled) {
    ...
    <img
      src="https://res.cloudinary.com/dcvqytwuq/image/upload/v1732771350/mwvg1ccvabzpd7fgpywh.jpg"
      alt="Harmony 4All"
...
{user.phone && (
    ...
    <strong>Website :</strong> <a href={`${user.website_url}`} style={{ color: 'inherit' }}>
       {user.website_name || user.website_url}
    </a>
)}
